...
namespace System.Windows.Forms
{
    public static class ControlExtension
    {
        ...
        public static void SetNewImage(this PictureBox pictureBox, Image newImage)
        {
            pictureBox.Image?.Dispose();
            pictureBox.Image = newImage;
        }

        public static void SetNewBackgroundImage(this PictureBox pictureBox, Image newImage)
        {
